...
namespace LOGIC.Services.User
{
    public class UserCompanyService : IGenericRelationshipService<CompanyResource>
    {
        ...
        public CompanyResource Attach(int userId, int companyId) => CompanyResource.FromEntity(_userCompanyRepository.Attach(userId, companyId));
        public CompanyResource Detach(int userId, int companyId) => CompanyResource.FromEntity(_userCompanyRepository.Detach(userId, companyId));
